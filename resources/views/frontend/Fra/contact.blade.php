...
@section('content')
    ...
    <div class="contact wow fadeInUp slow">
        <h5 style="text-align: center">En contact avec nous</h5>
        <hr class="" style="width: 80%">
                ...
                <div class="form">
                    <form action="/action_page.php">
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="lname" name="lastname" placeholder="Votre sujet">
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <textarea id="subject" name="subject" placeholder="Écris quelque chose.."
                                          style="height:200px"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <input class="btn btn-sm btn-primary offset-3" type="submit" value="Soumettre">
                        </div>
                    </form>
                </div>
            </div>
