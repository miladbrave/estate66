...
<div class="header">
    ...
    <a href="{{route('ara.home')}}"><img id="lan-img" src="{{asset('/med/logo.png')}}" width="90" height="80"
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="nav-back">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('ara.home')}}"><strong>الرئيسية</strong><span
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{route('ara.service')}}">الخدمات1</a>
                            <a class="dropdown-item" href="{{route('ara.service')}}">الخدمات2</a>
                            <a class="dropdown-item" href="{{route('ara.service')}}">الخدمات3</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('ara.proj')}}"><strong>مشاريع</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('ara.info')}}"><strong>معلومات</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('ara.about')}}"><strong>عنا</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('ara.contact')}}"><strong>اتصل&nbspبنا</strong></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 mx-auto my-md-4 my-0 mt-4 mb-1">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="{{route('ara.home')}}">الرئيسية</a>
                        </li>
                        <li>

                            <a href="{{route('ara.proj')}}">مشاريع</a>
                        </li>
                        <li>

                            <a href="{{route('ara.about')}}">عنا</a>
                        </li>
                        <li>

                            <a href="{{route('ara.service')}}">الخدمات</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
                    ...
                    <p style="text-align: right;direction: rtl;float: right">
                        تعمل الشركة faisle trading company LTD في شمال قبرص منذ عام 2002 وهي شركة مرخصة ومسجلة بالكامل ، مع توسيع الطلاب إلى شمال قبرص. والمهنية المهنية تواصل العمل.
                    </p>
                </div>
